                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="pt-4">
                        <button
                            ...
                            className="px-8 py-4 bg-accent text-background font-medium hover:bg-primary transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed w-full md:w-auto mt-4 border border-surface"
                        >
                            {status === 'sending' ? 'Sending...' : status === 'success' ? 'Transmitted' : 'Initialize Connection'}
                        </button>
                    </div>
                </form>
            </motion.div>
